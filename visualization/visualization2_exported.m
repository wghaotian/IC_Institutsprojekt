classdef visualization2_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        SelectSceneDropDown_2Label      matlab.ui.control.Label
        SelectSceneDropDown_2           matlab.ui.control.DropDown
        StartAppButton_2                matlab.ui.control.Button
    ...
    methods (Access = private)
        ...
        % Value changed function: SelectSceneDropDown_2
        ...
        % Button pushed function: StartAppButton_2
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create SelectSceneDropDown_2Label
            app.SelectSceneDropDown_2Label = uilabel(app.LeftPanel);
            app.SelectSceneDropDown_2Label.HorizontalAlignment = 'right';
            app.SelectSceneDropDown_2Label.Position = [14 382 80 22];
            app.SelectSceneDropDown_2Label.Text = 'Select Scene:';

            % Create SelectSceneDropDown_2
            app.SelectSceneDropDown_2 = uidropdown(app.LeftPanel);
            app.SelectSceneDropDown_2.Items = {'Nothing', 'AC-Mitte -> Köln'};
            app.SelectSceneDropDown_2.ItemsData = {'1', '2'};
            app.SelectSceneDropDown_2.ValueChangedFcn = createCallbackFcn(app, @SelectSceneDropDown_2ValueChanged, true);
            app.SelectSceneDropDown_2.Position = [109 382 100 22];
            app.SelectSceneDropDown_2.Value = '1';

            % Create StartAppButton_2
            app.StartAppButton_2 = uibutton(app.LeftPanel, 'push');
            app.StartAppButton_2.ButtonPushedFcn = createCallbackFcn(app, @StartAppButton_2Pushed, true);
            app.StartAppButton_2.Position = [66 424 100 22];
            app.StartAppButton_2.Text = 'Start App';
